...
export class PepperService extends BasePlatformService {
  private readonly SANDBOX_API_URL = 'https://sandbox.api.pepper.com.br/v1';
  private readonly PRODUCTION_API_URL = 'https://api.pepper.com.br/v1';
  ...
  protected getHeaders(): Record<string, string> {
    return {
      ...super.getHeaders(),
      'X-Pepper-Key': this.apiKey,
      'X-Pepper-Signature': this.generateSignature()
    };
  }
