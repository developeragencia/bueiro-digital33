...
export class HublaService extends BasePlatformService {
  private readonly SANDBOX_API_URL = 'https://api.sandbox.hubla.com/v1';
  private readonly PRODUCTION_API_URL = 'https://api.hubla.com/v1';
  ...
  private calculateSignature(payload: any): string {
    const hmac = require('crypto').createHmac('sha256', this.config.secretKey);
