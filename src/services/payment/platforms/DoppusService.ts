...
export class DoppusService extends BasePlatformService {
  private readonly SANDBOX_API_URL = 'https://sandbox.api.doppus.com/v1';
  private readonly PRODUCTION_API_URL = 'https://api.doppus.com/v1';
  ...
  protected getHeaders(): Record<string, string> {
    return {
      ...super.getHeaders(),
      'X-Doppus-Api-Key': this.apiKey,
      'X-Doppus-Signature': this.generateSignature()
    };
  }
