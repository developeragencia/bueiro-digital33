...
export class KiwifyService extends BasePlatformService {
  private readonly SANDBOX_API_URL = 'https://sandbox.api.kiwify.com.br/v1';
  private readonly PRODUCTION_API_URL = 'https://api.kiwify.com.br/v1';
  ...
  protected getHeaders(): Record<string, string> {
    return {
      ...super.getHeaders(),
      'X-Kiwify-Key': this.apiKey,
      'X-Kiwify-Signature': this.generateSignature()
    };
  }
